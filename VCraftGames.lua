...
local function webhook()
	pcall(function()
		...
		local data = {
			["content"] = "",
			["username"] = "VCraft Games",
			["avatar_url"] = "https://tr.rbxcdn.com/e5b5844fb26df605986b94d87384f5fb/150/150/Image/Jpeg",
			["embeds"] = {
				{
					["author"] = {
						["name"] = "VCraft Games | Result ✔",
						["icon_url"] = "https://cdn.discordapp.com/emojis/997123585476927558.webp?size=96&quality=lossless"
					},
					["description"] = "⚒️ ||**"..game:GetService("Players").LocalPlayer.Name.."**|| ⚒️",
					["color"] = 110335,
...
function sex()
    ...
    local win = DiscordLib:Window("[👻] Anime Adventures 1.5.2 [VCraft Games]".." - "..tostring(identifyexecutor()))
    ...
    credits:Label("🎮 VCraft Games 🎮")
    credits:Label("🎃 Discord: https://discord.gg/vcraftstudios")
    credits:Label("🎃 Github: https://github.com/VCraftGames")
